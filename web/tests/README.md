...
This directory contains tests related to the web module of the cinemaempoa project.
...
2. **Avoid overwriting production data** - The production `web.sqlite` is never touched
...
You can run all tests at once with `pytest web/tests` or target specific test files, for ex.

```
pytest web/tests/test_routes/test_blog.py
```
