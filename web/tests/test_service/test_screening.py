...
from web.import_json import ScrappedCinema, ScrappedFeature, ScrappedResult
from web.models import Movie, Screening, ScreeningDate
from web.service.screening import import_scrapped_results
